...
// Artifact represents a veil template as the result of a Packer build.
type Artifact struct {
	client *veil.WebClient
	config *Config
	//template *veil.CreateTemplateResponse
	template *veil.DomainObject
...
// Destroy the veil template represented by the artifact.
func (a *Artifact) Destroy() error {
	log.Printf("Destroying template: %s", a.template.VerboseName)
...
func (a *Artifact) String() string {
	return fmt.Sprintf("A template was created: %s", a.template.VerboseName)
